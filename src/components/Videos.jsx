  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        {/* Conditional rendering: show video if open, otherwise show thumbnail */}
        {!isVideoOpen ? (
          ...
          <div className="relative w-full h-auto">
            <button onClick={closeVideo} className="absolute -top-10 right-0 p-2 text-gray-800 hover:text-black transition-colors duration-200">
                <X className="w-8 h-8" />
            </button>
            <video
                ref={videoRef}
