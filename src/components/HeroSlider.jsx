                ...
                >
                  ...
                  <div className="overflow-hidden">
                    ...
                    >
                      ...
                      <button 
                        className="group relative overflow-hidden bg-red-700 hover:bg-red-800 text-white px-10 py-4 rounded-full font-semibold text-lg transition-all duration-300 ease-out transform focus:outline-none focus:ring-4 focus:ring-red-500/30 hover:shadow-xl hover:shadow-red-900/30 active:scale-95"
