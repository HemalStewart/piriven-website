...
const DownloadsPage = () => {
  ...
  const pdfs = {
    Policies: [
      ...
      {
        name: 'School ICT Integration Policy',
        url: '/pdfs/pdf-1.pdf',
        size: '600KB',
        date: 'July 2018',
        department: 'ICT Division',
      ...
      {
        name: 'National Inclusive Education Policy',
        url: '/pdfs/pdf-1.pdf',
        size: '820KB',
        date: 'May 2020',
        department: 'Policy Division',
      ...
      {
        name: 'Early Childhood Education Policy',
        url: '/pdfs/pdf-1.pdf',
        size: '1.4MB',
        date: 'January 2021',
        department: 'Child Education Division',
        classification: 'Public Document'
      },
      {
        name: 'Teacher Recruitment and Training Policy',
        url: '/pdfs/pdf-1.pdf',
        size: '1.1MB',
        date: 'October 2019',
          ...
          {pdfs[selectedDoc] && pdfs[selectedDoc].length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {pdfs[selectedDoc].map((pdf, index) => (
                <div key={pdf.name} className="group bg-white rounded-lg shadow-lg hover:shadow-lg transition-all duration-500 hover:-translate-y-3 border border-gray-200 hover:border-gray-300 overflow-hidden">
